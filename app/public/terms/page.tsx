...
const Index: FC<any> = () => {
  ...
  return (
    <>
      <PageTitle description='Digital Assessment Designer'>서비스 이용약관</PageTitle>
      <CustomLogo>
        <Link
          ...
          <div className='fs-18px fw-700 lh-1 ls-n1'>{token ? '서비스 이용약관' : '홈페이지'}</div>
        </Link>
      </CustomLogo>
      ...
      <Sticky className='d-none d-lg-flex align-items-center justify-content-between mt-16px py-16px bg-body'>
        <Link
          ...
          <div className='fs-22px fw-700 lh-1 ls-n1'>서비스 이용약관</div>
        </Link>
