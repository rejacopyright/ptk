...
export const getCurrentProperty: any = () => {
  let kt_header: any = document.getElementById('kt_header')
  let kt_toolbar: any = document.getElementById('kt_toolbar')
  kt_header = kt_header?.offsetHeight || 0
  kt_toolbar = kt_toolbar?.offsetHeight || 0
  return { kt_header, kt_toolbar }
}
