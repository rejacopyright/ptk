    ...
    <div
      ...
      <div
        ...
        <div className='btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px'>
          <KTSVG path='/media/icons/general/gen021.svg' className='svg-icon-1' />
        </div>
      </div>
      ...
      <div
        ...
        <div
          ...
          <form
            ...
            autoComplete='off'>
            <KTSVG
              path='/media/icons/general/gen021.svg'
            ...
            <div
              ...
              <div
                ...
                <KTSVG path='/media/icons/coding/cod001.svg' className='svg-icon-1' />
              </div>
              ...
              <div
                ...
                <KTSVG path='/media/icons/arrows/arr072.svg' className='svg-icon-2' />
              </div>
            </div>
          </form>
          ...
          <div ref={resultsElement} data-kt-search-element='results' className='d-none'>
            <div className='scroll-y mh-200px mh-lg-350px'>
              ...
              <a href='/#' className='d-flex text-dark text-hover-primary align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <img src='/media/placeholder/avatar.svg' alt='' />
                </div>
              ...
              <a href='/#' className='d-flex text-dark text-hover-primary align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/general/gen005.svg'
              ...
              <a href='/#' className='d-flex text-dark text-hover-primary align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/general/gen032.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <a href='/#' className='d-flex text-dark text-hover-primary align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/communication/com012.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <a href='/#' className='d-flex text-dark text-hover-primary align-items-center mb-5'>
                ...
                <div className='d-flex flex-column'>
                  <span className='fs-6 fw-bold'>Analitics Launch</span>
            ...
            <div className='scroll-y mh-200px mh-lg-325px'>
              <div className='d-flex align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/electronics/elc004.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <div className='d-flex align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/graphs/gra001.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <div className='d-flex align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/graphs/gra006.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <div className='d-flex align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/graphs/gra002.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <div className='d-flex align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/communication/com010.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
              ...
              <div className='d-flex align-items-center mb-5'>
                <div className='symbol symbol-40px me-4'>
                  <span className='symbol-label bg-light'>
                    <KTSVG
                      path='/media/icons/finance/fin001.svg'
                      className='svg-icon-2 svg-icon-primary'
                    />
                  </span>
                </div>
          ...
          <div ref={emptyElement} data-kt-search-element='empty' className='text-center d-none'>
            <div className='pt-10 pb-10'>
              <KTSVG path='/media/icons/files/fil024.svg' className='svg-icon-4x opacity-50' />
            </div>
        ...
        <form className={`pt-1 ${menuState === 'preferences' ? '' : 'd-none'}`}>
          ...
          <div className='py-4 border-bottom'>
            <label className='form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack'>
              ...
              <input name='affiliate' className='form-check-input' type='checkbox' value='1' />
            </label>
          </div>
          ...
          <div className='py-4 border-bottom'>
            <label className='form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack'>
              ...
              <input name='users' className='form-check-input' type='checkbox' />
            </label>
          </div>
